...
class ERPluginOrig(StrategyPlugin):
    """
    ...
    def load_buffer_batch(storage_policy, strategy, nb=None):
        ...
        new_dset = ERPluginOrig.retrieve_random_buffer_batch(storage_policy, n_exemplars)  # Dataset object
...
class ERStrategyOrig(BaseStrategy):
